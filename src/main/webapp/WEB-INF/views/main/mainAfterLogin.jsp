...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/indiv/main/mainpage/mainAfterLogin.css">
</head>
<body>
    <!-- 메인페이지 헤더 -->
    <header>
    ...
    <section id="mainPage-section1">
       <div class="section-wrapper1">
           <article id="section1-article1">
               ...
               <div id="section1-article1-btn"></div>
           </article>
    ...
    <section id="mainPage-section3">
       ...
       <article id="section3-article1">
             <div class="aaa">
                ...
                <span class="title2" style="color:white;">See how the pieces of your project fit together</span><br>
                <span class="title2" style="color:white;">and keep work on track as things change.</span>
             </div>
              <div id="img_timeline">
