...
<body>
    ...
    <header>
        <div id="head-wrapper">
            ...
            <div id="header-right"><div class="loginBtn"><a href="loginfirst.me">Login</a></div><div class="joinBtn"><a href="memberJoinForm.me" style="color:white;">Get Started</a></div></div>
        </div>
    </header>
    ...
    <section id="mainPage-section1">
       <div class="section-wrapper1">
           <article id="section1-article1">
               ...
               <div id="section1-article1-title2">STEPUP gives you everything  <br>you need to stay in sync, <br> hit deadlines, and reach your goals.</div>
               <div id="section1-article1-btn"><div class="joinBtn"><a href="memberJoinForm.me" style="color:white;">Get Started</a></div><div class="contactBtn"><a href="" >Contact Us</a></div></div>
           </article>
    ...
    <section id="mainPage-section2">
           <div id="mainPageCkickMe">How To Use !</div>
           <div class="section-wrapper21">   
              ...
              <img id="gif" src="${pageContext.request.contextPath}/resources/images/indiv/main/mainpage/stepupGif.gif">
           </div>
    </section>
    ...
    <section id="mainPage-section3">
       ...
       <article id="section3-article2">
             <div class="bbb sprinSection">
                <span class="title1">Sprint Backlog</span><br>   
                <span class="title2">You can create sprints and tasks, <br> also can start a sprint.</span><br>
             </div>
             <div class="ccc boardSection">
             ...
             <div class="ddd issueSection">
                <span class="title1">Issue</span><br>   
                <span class="title2">Let you adjust details <br>about tasks and sub-tasks!</span>
             </div>
       </article>
       ...
       <article id="section3-article3">
          ...
          <div class="eee standUpMeetingSection">
    ...
    <section id="mainPage-section5">Want to know more about STEPUP for your enterprise?
    </section>
      ...
      <div class="ft" align="center">
         <div id="footer-left">
                ...
                <div class="footer footer-content">
                    상호명 : (주)STEPUP | 대표 : 김정수 | 사업자 등록번호 : 211-88-04999 |<br> | 통신판매업 신고번호 : 2020 - 서울 강남구 -0333 | <br>
                    영업소재지: 서울특별시 강남구 테헤란로14길 6 남도빌딩 2층 C강의실 | 이메일: yourEmail@gmail.com 
                </div>
            </div>
            <div id="footer-right">
                <div class="footer footer-client">
                    <div>고객센터 <br> 대표번호 : 1234-4321 <br>| 이용약관  |<br>
                    | 개인정보처리방침</div>
                </div>
            </div>    
      </div>
