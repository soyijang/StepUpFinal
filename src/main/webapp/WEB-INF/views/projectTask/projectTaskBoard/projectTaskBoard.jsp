	...
	if($('#groupbyCategory').text() == "하위작업" && selectedMainTaskList != null){
		...
		for(var i = 0; i < selectedMainTaskList.length; i++){
			...
			var sContentBox = $('#contentBox2-board');
 			sContentBox.append("<div id='s" + selectedMainTaskList[i].taskCode + "' ><div class='sTitle'><div></div><div class='sicon'>S</div><div class='stcode'>" 
					...
					+ "</div><div class='sboard siboard'>" 
					+ "</div><div class='sboard spboard'></div><div class='sboard scboard'></div></div>");

 			//하위 테스크 그려주기
 			if(selectedSubTaskList != null){
				//기존 미진행 박스 안에 내용 지우기
				var siboard = $('#s' + selectedMainTaskList[i].taskCode + ' .siboard');
