...
public class MyTasksController {
	 ...
	 * //조회
	 * 
	 * @PostMapping("myTaskSelect.mt") public String showMyTasks(Member m,Model
	 * model, HttpSession session ) {
	 * 
	 * try { Member loginUser= ms.loginMember(m); session.setAttribute("loginUser",
	 * loginUser);
	 * 
	 * MyTask[] showMyTask = mt.showMyTasks(m);
	 * 
	 * return "userMyTasks/userMyCalendar/userCalenverMain"; } catch
	 * (LoginFailedException e) { model.addAttribute("msg", e.getMessage()); return
	 * "common/errorPage"; }
	 * 
	 * }
	 */
